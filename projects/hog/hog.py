...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    elif num_rolls>0 and num_rolls<=10 :
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def always_roll_(score,opponent_score):
        return n
    return always_roll_
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    flag=boar_brawl(score,opponent_score)
    if flag>=threshold:
        return 0
    else :
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    b_score=boar_brawl(score,opponent_score)
    s_score=sus_points(score+b_score)
    diff=s_score-score
    if(diff>=threshold):
        return 0
    else :
